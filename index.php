...
<body>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-TLB0ZMN83V"></script>
    <script>
 ...
 banner -->
    ...
    <section class="slider-parallax popup-video-banner bg-15">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="slider-content text-left">
                            ...
                            <br>
                            <h2 class="text-white" style="width: 80%;"> Tomamos tu usado como parte de pago.</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <br>
                    <h2 style="width: 80%;color:rgb(5, 5, 109)"> Tomamos tu usado como parte de pago.</h2>
 ...
 banner -->
    ...
    <section class="overview page-section-ptb bg-17">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="overview-content">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="white-form">
                        ...
                        <form class="form-horizontal contact__form" id="contactform" role="form" method="post" action="enviar.php">
